...
namespace NLayerProject.Data.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductID", "CategoryID", "InnerBarcode", "IsDeleted", "Name", "Price", "Stock" },
                values: new object[,]
                {
                    { 1, 1, null, false, "Pilot Kalem", 12.50m, 100 },
                    { 2, 1, null, false, "Kurşun Kalem", 40.50m, 60 },
                    { 3, 1, null, false, "Tükenmez Kalem", 20.50m, 150 },
                    { 4, 2, null, false, "Küçük Boy Defter", 12.50m, 100 },
                    { 5, 2, null, false, "Orta Boy Defter", 12.50m, 100 },
                    { 6, 2, null, false, "Büyük Boy Defter", 22.50m, 200 }
                });
